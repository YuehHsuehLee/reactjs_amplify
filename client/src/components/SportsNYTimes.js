...
class SportsNYTimes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
    ...
    componentDidMount() {
        ...
        .then( (result) => {
                ...
                () => console.log('NYTimes Sports Result fetched...', result.results))
              })
  }
...
render() {
    ...
    const temp1 = temp.filter(article => article.section == 'sports');
