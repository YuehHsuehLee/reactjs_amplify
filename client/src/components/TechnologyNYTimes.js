...
class TechnologyNYTimes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
    ...
    componentDidMount() {
        ...
        .then( (result) => {
                ...
                () => console.log('NYTimes Technology Result fetched...', result.results))
              })
  }
...
render() {
    ...
    const temp1 = temp.filter(article => article.section == 'technology');
...
export default TechnologyNYTimes;
